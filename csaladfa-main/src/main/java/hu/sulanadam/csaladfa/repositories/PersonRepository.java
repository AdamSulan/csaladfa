...
public interface PersonRepository extends JpaRepository<Person, Long> {
       ...
       @Query("SELECT new hu.sulanadam.csaladfa.dtos.personDtos.out.PersonDTOShortest(" +
       ...
       @Query("SELECT DISTINCT new hu.sulanadam.csaladfa.dtos.personDtos.out.PersonDTOShortest(" +
        "p.id, p.name, p.sex, p.birthDate, p.birthLocation, " +
        "p.deathDate, p.deathLocation) " +
        "FROM Person p")
